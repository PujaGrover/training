package com.veritis.xml.parse.demo.xslt;
...
public class SimpleTransform
{
	...
	transformer.transform(new StreamSource("empdetails.xml"), new StreamResult(new FileOutputStream("sageit.html")));
	...
	System.out.println("************* The result is in sageit.html*************");
